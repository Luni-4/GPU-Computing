...
\begin{frame}{Reti Neurali}
    ...
    \begin{itemize} [<+->]
        ...
        \item \large A differenza della sigmoide passa dall'origine con $x = 0$ 
...
\begin{frame}{Analisi dei Risultati}
    ...
    \begin{itemize} [<+->]
        \setlength\itemsep{2.5em}
        \item \large I diversi valori del learning rate $\eta$ utilizzati per testare la rete si ottengono campionando l'intervallo $[0.001, 0.8]$ con uno step di $0.05$
        ...
        \begin{table}
            ...
            \begin{tabular}{| c | c | c | c | c | c |}
                ...
                \multirow{2}{*}{2} & EduCNN & 0.21 & 90.64\% & 14 & \multirow{2}{*}{1.17} \\ \cline{2-5}
                                   & CUDA   & 0.20 & 84.93\% & 12 & \\
                \hline
                \multirow{2}{*}{3} & EduCNN & 0.18 & 90\% & 20 & \multirow{2}{*}{1.17} \\ \cline{2-5} 
                                   & CUDA   & 0.20 & 80\% & 20 & \\
                \hline
                \multirow{2}{*}{4} & EduCNN & 0.18 & 90\% & 20 & \multirow{2}{*}{1.17} \\ \cline{2-5}
                                   & CUDA   & 0.20 & 80\% & 20 & \\
                \hline                
            \end{tabular}
            \caption
