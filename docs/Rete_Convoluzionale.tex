    ...
    \framesubtitle{Risultati}
        ...
        \begin{table}
            ...
            \begin{tabular}{| c | c | c | c | c | c |}
                ...
                \hline
                \multirow{2}{*}{1} & \multirow{2}{*}{0.09} & EduCNN & 30.50\% & 197 & \multirow{2}{*}{3.12} \\ \cline{3-5} 
                                   &                       & CUDA   & 30.50\% & 63  & \\
                \hline
                \multirow{2}{*}{2} & \multirow{2}{*}{0.24} & EduCNN & 88.35\% & 184 & \multirow{2}{*}{2.60} \\ \cline{3-5} 
                                   &                       & CUDA   & 88.35\% & 71  & \\
                \hline
                \multirow{2}{*}{3} & \multirow{2}{*}{0.62} & EduCNN & 93.80\% & 599 & \multirow{2}{*}{3.10} \\ \cline{3-5} 
                                   &                       & CUDA   & 93.78\% & 193  & \\
                \hline
                \multirow{2}{*}{4} & \multirow{2}{*}{1.11} & EduCNN & 88.63\% & 680 & \multirow{2}{*}{3.16} \\ \cline{3-5} 
                                   &                       & CUDA   & 92.17\% & 215  & \\
                \hline
            \end{tabular}
    ...
    \framesubtitle{Risultati}
         ...
         \begin{table}
            ...
            \begin{tabular}{| c | c | c | c | c | c |}
                ...
                \emph{Configurazione} & $\eta$ & \emph{Rete} & \emph{Accuratezza} & \emph{Tempo [s]} & \emph{Speedup} \\
                \hline
                \multirow{2}{*}{1} & \multirow{2}{*}{0.09} & EduCNN & 92.18\% & 178 & \multirow{2}{*}{2.82} \\ \cline{3-5} 
                                   &                       & CUDA   & 92.51\% & 63  & \\
                \hline
                \multirow{2}{*}{2} & \multirow{2}{*}{0.24} & EduCNN & 86.07\% & 193 & \multirow{2}{*}{2.7} \\ \cline{3-5} 
                                   &                       & CUDA   & 80.57\% & 71  & \\
                \hline
                \multirow{2}{*}{3} & \multirow{2}{*}{0.62} & EduCNN & 94.32\% & 624 & \multirow{2}{*}{3.2} \\ \cline{3-5} 
                                   &                       & CUDA   & 93.11\% & 195  & \\
                \hline
                \multirow{2}{*}{4} & \multirow{2}{*}{1.11} & EduCNN & 9.58\% & 649 & \multirow{2}{*}{3.16} \\ \cline{3-5} 
                                   &                       & CUDA   & 9.58\% & 215  & \\
                \hline
            \end{tabular}
            \caption                        
    {\tabular[t]{@{}l@{}}Risultati ottenuti eseguendo alcune delle configurazioni \\ a partire da pesi iniziali generati casualmente in ambiente Linux \endtabular}          
        \end{table}    
\end{frame}
...
\begin{frame}{Analisi dei Risultati}
    \framesubtitle{Risultati}
           ...
           \begin{table}
            ...
            \end{tabular}
            \caption                        
    {\tabular[t]{@{}l@{}}Risultati ottenuti eseguendo alcune delle configurazioni \\ a partire da pesi iniziali generati casualmente in ambiente Windows \endtabular}          
        \end{table}    
\end{frame}
...
\begin{frame}{Analisi dei Risultati}
    \framesubtitle{Risultati}
        ...
        \begin{table}
            ...
            \end{tabular}
            \caption            
    {\tabular[t]{@{}l@{}}Valori di accuratezza e tempo impiegato dalle due reti \\ usando un numero di epoche pari a $10$ \endtabular}          
        \end{table}    
\end{frame}
...
\begin{frame}{Analisi dei Risultati}
    \framesubtitle{Risultati}
        ...
        \begin{table}
            ...
            \end{tabular}
            \caption            
    {\tabular[t]{@{}l@{}}Valori di accuratezza e tempo impiegato dalle due reti \\ usando come database Cifar \endtabular}          
        \end{table}    
\end{frame}
...
\begin{frame}{Analisi dei Risultati}
    ...
    \begin{itemize} [<+->]
        \setlength\itemsep{2em}
        \item \large Da fare %La massima differenza tra le accuratezze delle reti è del 6\%. Questa differenza è dovuta ai diversi algoritmi utilizzati dalla GPU e dalla CPU per generare i pesi casuali iniziali. A parità di pesi iniziali e di learning rate entrambe le reti producono lo stesso livello di accuratezza
        \item \large Da fare %Lo speedup è significativo nelle configurazioni 1 e 3, ma inesistente o nullo nelle altre. Con kernel e livelli fully-connected di grossa taglia si ottiene un notevole vantaggio utilizzando il parallelismo, mentre per livelli più piccoli risulta migliore un approccio di tipo sequenziale
    \end{itemize}     
\end{frame}
