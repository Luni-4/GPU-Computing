...
\begin{frame}{Reti Neurali}
    ...
    \begin{itemize} [<+->]
        ...
        \item \large Il \emph{learning rate} $\eta$ è un parametro usato per controllare la velocità di convergenza della rete al valore minimo. Un learning rate alto comporta step elevati nell'aggiornamento dei pesi, un tempo di esecuzione più basso, ma una maggiore probabilità di terminare in un minimo locale
    \end{itemize}      
\end{frame}
