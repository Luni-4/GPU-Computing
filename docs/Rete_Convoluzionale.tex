    ...
    \framesubtitle{Librerie}
      \begin{itemize} [<+->] 
        \setlength\itemsep{1em}           
            ...
            \item \large Durante la costruzione della rete, più di preciso nell'esecuzione dei test intermedi, si è osservato che la funzione adibita al calcolo del prodotto tra matrici \emph{cublasGemm} risulta più lenta di \emph{cublasGemv} che effettua il prodotto tra matrici e vettori
            ...
            %\item \large I pesi iniziali della rete sono generati in maniera casuale per mezzo della funzione \emph{cuRandUniform} contenuta nella libreria CUDA \emph{cuRand}
        \end{itemize}
\end{frame}
...
\begin{frame}{Implementazione della Rete}
    ...
    \begin{itemize} [<+->]
        \setlength\itemsep{2em}
        %\item \large La EduCNN genera numeri casuali usando la funzione \emph{rand} del C
...
\begin{frame}{Implementazione della Rete}
    ...
    \begin{itemize} [<+->]
        ...
        %\item \large Alcune delle configurazioni vengono eseguite utilizzando le funzioni per la generazione dei numeri casuali messe a disposizione dalle reti
