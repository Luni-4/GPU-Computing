    ...
    \framesubtitle{Librerie}
      \begin{itemize} [<+->] 
        \setlength\itemsep{1em}           
            ...
            %\item \large I pesi iniziali della rete sono generati in maniera casuale utilizzando l'algoritmo \emph{xorWow} contenuto nella libreria CUDA \emph{cuRand}
        \end{itemize}
\end{frame}
...
\begin{frame}{Implementazione della Rete}
    ...
    \begin{itemize} [<+->]
        \setlength\itemsep{2em}
        %\item \large La EduCNN utilizza il generatore di numeri casuali \emph{xorshift128} per ricavare i valori dei pesi iniziali
...
\begin{frame}{Implementazione della Rete}
    ...
    \begin{itemize} [<+->]
        ...
        %\item \large Si è scelto di eseguire alcune configurazioni generando i pesi iniziali in maniera casuale in modo da valutare la differenza tra le accuratezze ottenute dalle due reti
        ...
        \begin{table}
            ...
            \begin{tabular}{| c | c | c | c | c | c |}
                ...
                \multirow{2}{*}{2} & \multirow{2}{*}{0.56} & EduCNN & 97.60\% & 121 & \multirow{2}{*}{2.22} \\ \cline{3-5} 
                                   &                       & CUDA   & 93.86\% & 55  & \\
                \hline
                \multirow{2}{*}{3} & \multirow{2}{*}{0.56} & EduCNN & 97.60\% & 121 & \multirow{2}{*}{2.22} \\ \cline{3-5} 
                                   &                       & CUDA   & 93.86\% & 55  & \\
                \hline
                \multirow{2}{*}{4} & \multirow{2}{*}{0.56} & EduCNN & 97.60\% & 121 & \multirow{2}{*}{2.22} \\ \cline{3-5} 
                                   &                       & CUDA   & 93.86\% & 55  & \\
                \hline
            \end{tabular}
            \caption{Risultati ottenuti dalle configurazioni testate}          
        %\end{table} 
            %\caption            
...
\begin{frame}{Analisi dei Risultati}
    \framesubtitle{Risultati}
        ...
        \begin{table}
            ...
            \end{tabular}
            \caption            
    {\tabular[t]{@{}l@{}}Valori di accuratezza e tempo impiegato dalle due reti \\ a partire da pesi iniziali generati casualmente \endtabular}          
        \end{table}    
\end{frame}
